...
namespace PRENATALv2.Areas.Home.Models
{
    public class Register
    {
        ...
        [Required(ErrorMessage = "This field is required!")]
        [Remote("IsEmailTaken", "RemoteValidation", "Admin", ErrorMessage = "E-mail in use!", HttpMethod = "POST", AdditionalFields = "__RequestVerificationToken")]
        public string Email { get; set; }

        [Required]
        [DataType(DataType.PhoneNumber)]
        [RegularExpression("(\\+)([0-9]{11,})",ErrorMessage ="Format:+38733111222")]
        [Remote("IsPhoneNumberTaken", "RemoteValidation", "Admin", ErrorMessage ="PhoneNumber in use!", HttpMethod ="POST", AdditionalFields = "__RequestVerificationToken")]
